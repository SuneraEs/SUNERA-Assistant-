...
# Эта переменная должна содержать путь к вашей папке с файлами,
# которые бот будет использовать для ответов (например, с PDF, .txt, .docx).
KNOWLEDGE_BASE_PATH = "knowledge_base"

# Это имя файла, в котором будет храниться векторная база данных.
# Не меняйте его, если не знаете зачем.
FAISS_DB_PATH = "faiss_index"

# Название модели, которую будем использовать для создания векторов.
# Это модель, которая превращает текст в числовые представления.
