...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    USER[chat_id] = {"lang": "Русский", "state": None}
    kb = main_menu_kb("Русский")
...
[IndentationError: unindent does not match any outer indentation level](https://www.youtube.com/watch?v=deLgvUfNTG4)
This video explains the cause of the `IndentationError` in Python and how to fix it, which is the exact issue you're facing.
